...
public class AliPayUtil {
     ...
     * @return
     */
    public static String unifiedorder(AlipayTradeAppPayModel model, AlipayConfig config, AlipayTradeAppPayRequest request) {
        AlipayClient alipayClient = null;
        try {
            alipayClient = new DefaultAlipayClient(config);
        } catch (AlipayApiException e) {
     ...
     * @return
     */
    public static String unifiedorder(AlipayTradeWapPayModel model, AlipayConfig config, AlipayTradeWapPayRequest request) {
        AlipayClient alipayClient = null;
        try {
            alipayClient = new DefaultAlipayClient(config);
        } catch (AlipayApiException e) {
